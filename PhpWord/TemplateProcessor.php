...
use PhpOffice\PhpWord\Shared\StringElement; //primer cambio copiar el archivo StringElement.php para solucionar la incompatibilidad de php 7 y php5 y en la linea 364 cambiar String por StringElement
