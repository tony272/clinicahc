...
$medicalreports = MedicalreportData::getById($_GET["id"]);
?>
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header" data-background-color="blue">
          <h1 class="title">Generar Informe Médico</h1>
      </div>
      <div class="card-content table-responsive">
    		<form class="form-horizontal" method="post" id="addproduct" action="./report/report2-word.php" role="form">
        ...
        <!-- Fecha y hora de Reporte -->
          ...
          <div class="form-group">
            ...
            <div class="col-lg-3">
              <input type="date" name="attention_date" required class="form-control" value="<?php echo $medicalreports->attention_date; ?>" readonly id="inputEmail1" placeholder="Fecha">
            </div>
            <div class="col-lg-3">
              <input type="time" name="attention_hour" required class="form-control" value="<?php echo $medicalreports->attention_hour; ?>" readonly id="inputEmail1" placeholder="Hora">
            </div>
          </div>
        <!-- Fecha y hora de Reporte -->
          ...
          <div class="form-group">
            ...
            <div class="col-md-3">
              <input type="text" name="consultation_reason"  required class="form-control" value="<?php echo $medicalreports->consultation_reason; ?>" readonly id="consultation_reason" placeholder="Motivo de la Consulta">
            </div>
        ...
        <!-- Examen Clínico  -->
          ...
          <div class="form-group">
            ...
            <div class="col-lg-1">
              <input type="text" name="so2" required class="form-control" value="<?php echo $medicalreports->so2; ?>" readonly id="so2" placeholder="Sat. O2">
            </div>
            <label for="inputEmail1" class="col-lg-1 control-label">P.A.</label>
            <div class="col-lg-1">
              <input type="text" name="pa" required class="form-control" value="<?php echo $medicalreports->pa; ?>" readonly id="pa" placeholder="P.A.">
            </div>
            <label for="inputEmail1" class="col-lg-1 control-label">F.C.</label>
            <div class="col-lg-1">
              <input type="text" name="fc" required class="form-control" value="<?php echo $medicalreports->fc; ?>" readonly id="fc" placeholder="F.C.">
            </div>
            <label for="inputEmail1" class="col-lg-1 control-label">F.R.</label>
            <div class="col-lg-1">
              <input type="text" name="fr" required class="form-control" value="<?php echo $medicalreports->fr; ?>" readonly id="fr" placeholder="F.R.">
            </div>
            <label for="inputEmail1" class="col-lg-1 control-label">T°</label>
            <div class="col-lg-1">
              <input type="text" name="temperature" required class="form-control" value="<?php echo $medicalreports->temperature; ?>" readonly id="temperature" placeholder="T°">
            </div>
          </div>
