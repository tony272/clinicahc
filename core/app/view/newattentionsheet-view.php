...
<div class="card">
  <div class="card-header" data-background-color="blue">
      <h1>Nueva Ficha de Atención Médica</h1>
      <br>
  </div>
  <div class="card-content table-responsive">

		<form class="form-horizontal" method="post" id="addproduct" action="index.php?view=addattentionsheet" role="form">
...
-->
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-primary">Agregar Ficha de Atención</button>
    </div>
  </div>
