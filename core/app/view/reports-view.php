...
if($_GET["status_id"]!=""){
	...
	$sql .= " paymentc_id = ".$_GET["payment_id"];
}


if($_GET["pacient_id"]!=""){
if($_GET["status_id"]!=""||$_GET["paymentc_id"]!=""){
	$sql .= " and ";
}
...
if($_GET["medic_id"]!=""){
if($_GET["status_id"]!=""||$_GET["pacient_id"]!=""||$_GET["paymentc_id"]!=""){
	$sql .= " and ";
}
...
if($_GET["status_id"]!=""||$_GET["pacient_id"]!="" ||$_GET["medic_id"]!="" ||$_GET["paymentc_id"]!="" ){
	$sql .= " and ";
}
...
//echo $sql;
		...
		if(count($users)>0){
			...
			foreach($users as $user){
				...
				<td>S/ <?php echo number_format($user->price,2,".",",");?></td>
				</tr>
				<?php
				$total += $user->price;
