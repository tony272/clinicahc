...
<div class="card">
  <div class="card-header" data-background-color="blue">
      <h4 class="title">Editar Informe Médico</h4>
  </div>
  <div class="card-content table-responsive">

		<form class="form-horizontal" method="post" id="addproduct" action="index.php?view=updatemedicalreport" role="form">
...
<!-- Fecha y hora de Reporte -->
  ...
  <div class="form-group">
    ...
    <div class="col-lg-3">
      <input type="date" name="attention_date" required class="form-control" value="<?php echo $medicalreports->attention_date; ?>" id="inputEmail1" placeholder="Fecha">
    </div>
    <div class="col-lg-3">
      <input type="time" name="attention_hour" required class="form-control" value="<?php echo $medicalreports->attention_hour; ?>" id="inputEmail1" placeholder="Hora">
    </div>
  </div>
...
<!-- Fecha y hora de Reporte -->
  ...
  <div class="form-group">
    ...
    <div class="col-md-3">
      <input type="text" name="consultation_reason"  required class="form-control" value="<?php echo $medicalreports->consultation_reason; ?>" id="consultation_reason" placeholder="Motivo de la Consulta">
    </div>
...
<!-- Examen Clínico  -->
  ...
  <div class="form-group">
    ...
    <div class="col-lg-1">
      <input type="text" name="so2" required class="form-control" value="<?php echo $medicalreports->so2; ?>" id="so2" placeholder="Sat. O2">
    </div>
    <label for="inputEmail1" class="col-lg-1 control-label">P.A.</label>
    <div class="col-lg-1">
      <input type="text" name="pa" required class="form-control" value="<?php echo $medicalreports->pa; ?>" id="pa" placeholder="P.A.">
    </div>
    <label for="inputEmail1" class="col-lg-1 control-label">F.C.</label>
    <div class="col-lg-1">
      <input type="text" name="fc" required class="form-control" value="<?php echo $medicalreports->fc; ?>" id="fc" placeholder="F.C.">
    </div>
    <label for="inputEmail1" class="col-lg-1 control-label">F.R.</label>
    <div class="col-lg-1">
      <input type="text" name="fr" required class="form-control" value="<?php echo $medicalreports->fr; ?>" id="fr" placeholder="F.R.">
    </div>
    <label for="inputEmail1" class="col-lg-1 control-label">T°</label>
    <div class="col-lg-1">
      <input type="text" name="temperature" required class="form-control" value="<?php echo $medicalreports->temperature; ?>" id="temperature" placeholder="T°">
    </div>
  </div>
