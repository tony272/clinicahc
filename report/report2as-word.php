...
include "../core/app/model/PacientData.php";
include "../core/app/model/MedicData.php";
include "../core/app/model/AttentionsheetData.php";
...
$templateWord = new TemplateProcessor('plantillaCMC2020.docx');
//$pacients = PacientData::getById($report->pacient_id);
//$medics = MedicData::getAll();
$report=AttentionsheetData::getById($_POST["id"]);//Ingresar aqui id de la ficha de atención aun no se como jalarlo de la url (ya jaló)   $report=MedicalreportData::getById("2");
$pacients = PacientData::getById($report->pacient_id);
...
// Resto de datos
$templateWord->setValue('fecha_atencion',$report->attentionas_date);
$templateWord->setValue('hora_atencion',$report->attentionas_hour);
$templateWord->setValue('motivo_consulta',$report->consultationas_reason);
...
$templateWord->setValue('sato2',$report->so2as);
$templateWord->setValue('pa',$report->paas);
$templateWord->setValue('fc',$report->fcas);
$templateWord->setValue('fr',$report->fras);
$templateWord->setValue('t',$report->temperatureas);
...
$filename = "Ficha Nº ".date("YmdHis").".docx";
